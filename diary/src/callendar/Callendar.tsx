...
const Callendar = () => {
   ...
   * 현재 일자 설정
   */
  const choiceCurrentDate = (date: number) => {
    let currentMonth: string = (month + 1).toString();
    ...
    setChooseDate(`${year}${currentMonth}${currentDate}`);
  };
  ...
  return (
    <>
      <div style={{ display: "flex", margin: "1em" }}>
        ...
        {chooseDate !== "" && (
          <ManageContainer>
            <ManageComponent chooseDate={chooseDate}></ManageComponent>
          </ManageContainer>
        )}
      </div>
