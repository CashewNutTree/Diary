 ...
 * @returns
 */
const DateComponent = ({year, month}: { year: any; month: any }) => {
    ...
    const [prevDatePassed, setPrevDatePassed] = useState<{ year: number; month: number; date: number; day: number }[]>([]);
    ...
    // );
    const [days, setDays] = useState<{ year: number; month: number; date: number; day: number }[]>([]);
